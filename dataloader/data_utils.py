...
def set_up_datasets(args):
    ...
    if args.dataset == 'StanfordDog':
        import dataloader.dog.dog as Dataset
        args.base_class = 80
...
def get_transform(args):
    ...
    if args.dataset in ['cub200','my_data','aircraft100','car100','StanfordDog']:
...
def get_base_dataloader(args):
    ...
    if args.dataset == 'StanfordDog':
        trainset = args.Dataset.DOG(root=args.dataroot, train=True, index=class_index, base_sess=True,
                                       crop_transform=crop_transform, secondary_transform=secondary_transform)
        testset = args.Dataset.DOG(root=args.dataroot, train=False, index=class_index)
    if args.dataset == 'aircraft100':
...
def get_new_dataloader(args, session):
    ...
    if args.dataset == 'car100':
        trainset = args.Dataset.CAR100(root=args.dataroot, train=True, index_path=txt_path,
                                       crop_transform=crop_transform, secondary_transform=secondary_transform)
    if args.dataset == 'StanfordDog':
        trainset = args.Dataset.DOG(root=args.dataroot, train=True, index_path=txt_path,
                                       crop_transform=crop_transform, secondary_transform=secondary_transform)
    if args.dataset == 'aircraft100':
    ...
    if args.dataset == 'car100':
        testset = args.Dataset.CAR100(root=args.dataroot, train=False,
                                      index=class_new)
    if args.dataset == 'StanfordDog':
        testset = args.Dataset.DOG(root=args.dataroot, train=False,
                                      index=class_new)
    if args.dataset == 'mini_imagenet':
